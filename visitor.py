from mongo.umuzi_prospects import Visitor
...
# print(create_visitor("visitor_thavha", "23", "name_of_the_assistor", "comments"))
...
# delete_visitor('62925c6d3f627854d48c34a3')
# print(list_visitors())
